...
class MainTest {
    ...
    void main() throws IOException {
        ...
        assertEquals("FileInformation.test\nFlags.test\nFunctions.test\nMain.test", flag.printDirectory(flag, new ByteArrayOutputStream()).toString());
        flag.setDirectory(new File("testfolder/blabla"));
        // Русский
        flag.setResource(ResourceBundle.getBundle("resources", new Locale("ru", "RU")));
        thrownDir = assertThrows(NoSuchFileException.class, () -> flag.printDirectory(flag, new ByteArrayOutputStream()));
        ...
        assertEquals("111 10.03.2020 15:19:53 601 Main.test", flag.printDirectory(flag, new ByteArrayOutputStream()).toString());
        ...
        assertEquals("111 10.03.2020 15:25:07 2221 Flags.test\n111 10.03.2020 16:29:30 6755 inner-folder",
                flag.printDirectory(flag, new ByteArrayOutputStream()).toString());
