...
class TailerLauncherTest {
    boolean equalFiles(String output, String expected) throws IOException {
        return Files.readAllLines(Paths.get(output)).equals(Files.readAllLines(Paths.get(expected)));
    }
    ...
    void testLastSymbols() throws IOException {
        ...
        assertTrue(equalFiles("test_files/output.txt", "test_files/expectedSym.txt"));
    }
    ...
    void testLast5Strings () throws IOException {
        ...
        TailerLauncher.main(args);
        assertTrue(equalFiles("test_files/output.txt", "test_files/expected5Str.txt"));
    }
    ...
    void testLast10Strings () throws IOException {
        ...
        TailerLauncher.main(args);
        assertTrue(equalFiles("test_files/output.txt", "test_files/expected10Str.txt"));
    }
